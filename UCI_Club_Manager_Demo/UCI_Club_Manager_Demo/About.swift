...
class About {
    ...
    init(id: String, time_stamp: String, club_id: String, paragraph: String, far_left_photo_url: String, left_photo_url: String, center_photo_url: String, right_photo_url: String, far_right_photo_url: String) {
        self.id = id
